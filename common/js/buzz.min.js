...
(function (t, n) {
    ...
    var t = window.AudioContext || window.webkitAudioContext, n = {audioCtx: t ? new t : null, defaults: {autoplay: !1, duration: 5e3, formats: [], loop: !1, placeholder: "--", preload: "metadata", volume: 80, document: window.document}, types: {mp3: "audio/mpeg", ogg: "audio/ogg", wav: "audio/wav", aac: "audio/aac", m4a: "audio/x-m4a"}, sounds: [], el: document.createElement("audio"), sound: function (t, e) {
        function i(t) {
        ...
        function s(t, e) {
            ...
            i.src = e, n.types[u(e)] && (i.type = n.types[u(e)]), t.appendChild(i)
        }

        e = e || {};
        var r = e.document || n.defaults.document, o = 0, a = [], h = {}, l = n.isSupported();
        if (this.load = function () {
            ...
            return isNaN(t) ? n.defaults.placeholder : t
        }, this.setPercent = function (t) {
            return l ? this.setTime(n.fromPercent(t, this.sound.duration)) : this
        }, this.getPercent = function () {
            if (!l)return null;
            var t = Math.round(n.toPercent(this.sound.currentTime, this.sound.duration));
            return isNaN(t) ? n.defaults.placeholder : t
            ...
            if (!l)return this;
            e instanceof Function ? (i = e, e = n.defaults.duration) : e = e || n.defaults.duration;
            var s = this.volume, r = e / Math.abs(s - t), o = this;
            ...
            for (var d in n.defaults)n.defaults.hasOwnProperty(d) && void 0 === e[d] && (e[d] = n.defaults[d]);
            if (this.sound = r.createElement("audio"), n.audioCtx && (this.source = n.audioCtx.createMediaElementSource(this.sound), this.source.connect(n.audioCtx.destination)), t instanceof Array)for (var c in t)t.hasOwnProperty(c) && s(this.sound, t[c]); else if (e.formats.length)for (var f in e.formats)e.formats.hasOwnProperty(f) && s(this.sound, t + "." + e.formats[f]); else s(this.sound, t);
            e.loop && this.loop(), e.autoplay && (this.sound.autoplay = "autoplay"), this.sound.preload = e.preload === !0 ? "auto" : e.preload === !1 ? "none" : e.preload, this.setVolume(e.volume), n.sounds.push(this)
        }
    }, group: function (t) {
        function n() {
        ...
        return new n.group(n.sounds)
    }, isSupported: function () {
        return!!n.el.canPlayType
    }, isOGGSupported: function () {
        return!!n.el.canPlayType && n.el.canPlayType('audio/ogg; codecs="vorbis"')
    }, isWAVSupported: function () {
        return!!n.el.canPlayType && n.el.canPlayType('audio/wav; codecs="1"')
    }, isMP3Supported: function () {
        return!!n.el.canPlayType && n.el.canPlayType("audio/mpeg;")
    }, isAACSupported: function () {
        return!!n.el.canPlayType && (n.el.canPlayType("audio/x-m4a;") || n.el.canPlayType("audio/aac;"))
